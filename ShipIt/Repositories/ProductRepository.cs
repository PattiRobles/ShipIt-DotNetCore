...
namespace ShipIt.Repositories
{
    ...
    public class ProductRepository : RepositoryBase, IProductRepository
    {
        ...
        {
            string sql = String.Format("SELECT p_id, gtin_cd, gcp_cd, gtin_nm, m_g, l_th, ds, min_qt FROM gtin WHERE p_id = @p_id",
                String.Join("','", ids));
            return base.RunGetQuery(sql, reader => new ProductDataModel(reader), "No products found with this p_id", null);
        }
